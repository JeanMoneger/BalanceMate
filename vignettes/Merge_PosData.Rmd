...
You first want to identify the path to your folder. In this example, the files are stored in the folder "extdata" in the package "BalanceMate"; but your path could be something like "User/Desktop/PostureData".
